...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$path1 = "EvidenciasVentas/$photo_name1.png";
	
	$name2 = "$unique$usuario$pharma_id$pos_id"."DESPUES";
	$full_name2 = str_replace(str_split('\\/:*?"<>|%+#'),'', $name2);
	$photo_name2 = str_replace(' ','', $full_name2);
	$path2 = "EvidenciasVentas/$photo_name2.png";
	
	// Insertar meta
    $retorno = FuncionesSamsung::insertEvidenciasVentas(
		$pharma_id,
		$pos_id,
        $usuario,
        $comentario,
    ...
    if ($retorno) {
        ...
        $container = 'app/AppAlicorp/Inserts/EvidenciasVentas';
