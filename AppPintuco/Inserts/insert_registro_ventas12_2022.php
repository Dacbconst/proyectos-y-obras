...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $path = "JornadaVentas/$photo_name.png";

    // Insertar meta
    $retorno = FuncionesSamsung::insertRegistroVentas12_2022(
        $id_pdv,
        $usuario,
		$tipo,
		$version,
    ...
    if ($retorno) {
        FuncionesSamsung::updateRuta($idRemotaRuta, $tipo, $hora, $distancia, $tipo_relevo);
        
        $container = 'app/AppAlicorp/Inserts/JornadaVentas';
