...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($image != 'NO_FOTO') {
        ...
        $path = "PdvFotografico/$photo_name.png";
    } else {
        $path = "PdvFotografico/NO_FOTO.png";
    }

    // Insertar meta
    $retorno = FuncionesSamsung::insertPdvFotografico(
        $pos_id,
        $user,
        $supervisor,
        $fecha,
    ...
    if ($retorno) {
        if ($image != 'NO_FOTO') {
            ...
            $container = 'app/AppAlicorp/Inserts/PdvFotografico';
