...
public class AdapterProductosEnMalEstado extends RecyclerView.Adapter<AdapterProductosEnMalEstado.ViewHolder> {
    ...
    private AdapterProductosEnMalEstado.OnItemClickListener escucha;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tv_Distribucion;
        ...
        public ViewHolder(View v) {
            ...
            tv_Distribucion = (TextView) v.findViewById(R.id.tv_Distribucion);
            ...
            sku_cliente = (TextView) v.findViewById(R.id.lblSkuCliente);
            litros = (TextView) v.findViewById(R.id.lblLitros);
            dias_restantes = (TextView) v.findViewById(R.id.lblDiasRestantes);
            valorizado = (TextView) v.findViewById(R.id.lblValorizado);
            ...
            distribucion = (TextView) v.findViewById(R.id.lblDistribucion);

        }
    }


    public AdapterProductosEnMalEstado(Context context) {
    ...
    @Override
    public AdapterProductosEnMalEstado.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.status_propensos_y_prod_mal_est, viewGroup, false);
        return new AdapterProductosEnMalEstado.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(AdapterProductosEnMalEstado.ViewHolder viewHolder, int i) {
        ...
        distribucion = cursor.getString(cursor.getColumnIndexOrThrow(ContractInsertPropensosYProdMalEst.Columnas.SOUVENIRS));
    ...
    //    viewHolder.segmento2.setText(segmento2);
        ...
        viewHolder.distribucion.setText(distribucion);
    //    viewHolder.tamano.setText(tamano);


        if (modulo.equalsIgnoreCase("PRODUCTOS EN MAL ESTADO")){
            ...
            viewHolder.tv_TipoConteoDefectuoso.setVisibility(View.VISIBLE);
            viewHolder.tipo_conteo_defectuoso.setVisibility(View.VISIBLE);
            viewHolder.tv_Defectuosos.setVisibility(View.VISIBLE);
            viewHolder.defectuosos.setVisibility(View.VISIBLE);
            viewHolder.tv_Causal.setVisibility(View.VISIBLE);
            viewHolder.causal.setVisibility(View.VISIBLE);
            viewHolder.tv_Distribucion.setVisibility(View.VISIBLE);
            viewHolder.distribucion.setVisibility(View.VISIBLE);
            ...
            viewHolder.tv_Distribucion.setVisibility(View.GONE);
            viewHolder.distribucion.setVisibility(View.GONE);
